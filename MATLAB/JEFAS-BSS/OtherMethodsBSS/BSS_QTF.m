...
%   eps3: imaginary part threshold for points selections
%   eps4: real part threshold for points selections
%   nn: number of cluster for column estimations (should be greater than the number of sources)
%
% Output:

...
load('../../signals/soundMixture2.mat');
[N,T] = size(z);
...
%% Save
save('../results/results2','indJEFAS','indSOBI','indQTF','indPSOBI','SDR0','SIR0','SDRsobi','SIRsobi','SDRpsobi','SIRpsobi','SDRqtf','SIRqtf','SDR','SIR');
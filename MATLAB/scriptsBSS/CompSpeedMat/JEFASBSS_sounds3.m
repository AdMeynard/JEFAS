...
load('../../signals/soundMixture3.mat');
[N,T] = size(z);
...
%% Save
save('../results/results3','indJEFAS','indSOBI','indQTF','indPSOBI','SDR0','SIR0','SDRsobi','SIRsobi','SDRpsobi','SIRpsobi','SDRqtf','SIRqtf','SDR','SIR');
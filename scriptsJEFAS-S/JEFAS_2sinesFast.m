%% JEFAS on the narrowband signal
...
Dt = 1 ; % temporal subsampling for the deformation estimation
...
NbScales = 125;
scalesAM = 2.^(linspace(-0.67,2.33,NbScales));
...
tic;
[aML, dgammaML, Sx, evol_crit] = estim_altern(y,Dt,ratio,dgamma0,a0,paramWAV,paramWP,paramAM,paramS,stop_crit,Nit);
toc;

save('results/JEFAS_2sinesfast','aML', 'dgammaML','Sx','y','Fs')
